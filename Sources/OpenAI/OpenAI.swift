...
final public class OpenAI: OpenAIProtocol {
    ...
    public struct Configuration {
      ...
      public let isUsingV1: Bool
        ...
        public init(token: String, organizationIdentifier: String? = nil, host: String = "api.openai.com", port: Int = 443, scheme: String = "https", timeoutInterval: TimeInterval = 60.0, isUsingV1: Bool = true) {
            self.token = token
...
extension OpenAI {
    ...
    func buildURL(path: String) -> URL {
      ...
      components.path = configuration.isUsingV1 ? "/v1" + path : path
